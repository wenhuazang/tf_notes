...
flags.DEFINE_string("output_dir", "./data/amazon_review_tfrecords/", "The directory name to save data")
flags.DEFINE_string("input_dir", "./data/amazon_review/", "The Directory name to input data")
